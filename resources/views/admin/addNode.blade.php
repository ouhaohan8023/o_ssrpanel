                ...
                <div class="tab-pane active">
                    <div class="portlet light bordered">
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <form action="{{url('wSifGFeO5mQoCWB4/addNode')}}" method="post" class="form-horizontal" onsubmit="return do_submit();">
                                <div class="form-body">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="portlet light bordered">
                                                ...
                                                <div class="portlet-body">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="root" class="col-md-3 control-label"> root </label>
                                                        <div class="col-md-8">
                                                            <input type="text" class="form-control" name="root" id="root" placeholder="服务器账号" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="pwd" class="col-md-3 control-label"> password </label>
                                                        <div class="col-md-8">
                                                            <input type="text" class="form-control" name="pwd" id="pwd" placeholder="服务器密码" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="pwd" class="col-md-3 control-label"> 端口 </label>
                                                        <div class="col-md-8">
                                                            <input type="text" class="form-control" name="serverport" id="serverport" placeholder="服务器端口" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        function do_submit() {
            ...
            $.ajax({
                type: "POST",
                url: "{{url('wSifGFeO5mQoCWB4/addNode')}}",
                async: false,
                data: {
                    _token:'{{csrf_token()}}',
                    name: name,
                ...
                success: function (ret) {
                    layer.msg(ret.message, {time:1000}, function() {
                        if (ret.status == 'success') {
                            window.location.href = '{{url('wSifGFeO5mQoCWB4/nodeList')}}';
                        }
                    });
                }
            });
