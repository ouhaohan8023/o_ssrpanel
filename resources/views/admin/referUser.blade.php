                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            <span class="caption-subject bold uppercase"> 代理关系列表 </span>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-2 col-sm-2">
                                <select class="form-control input-sm" name="status" id="status" onChange="doSearch()">
                                    ...
                                    <option value="0" @if(Request::get('status') == '-1') selected @endif>禁用</option>
                                </select>
                            </div>
                            <div class="col-md-2 col-sm-2">
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        function doSearch() {
            ...
            window.location.href = '{{url('wSifGFeO5mQoCWB4/referUser')}}' + '?user_id=' + user_id + '&ref_user_id=' + ref_user_id + '&sn=' + sn + '&status=' + status + '&start_time=' + start_time + '&end_time=' + end_time ;
        }

        // 重置
        function doReset() {
            window.location.href = '{{url('wSifGFeO5mQoCWB4/referUser')}}';
        }
