                ...
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 col-sm-2">
                                <select class="form-control input-sm" name="label" id="label" onChange="doSearch()">
                                    <option value="" @if(Request::get('label') == '') selected @endif>标签</option>
                                    <option value="0" @if(Request::get('label') == '0') selected @endif>未标记的</option>
                                    <option value="1" @if(Request::get('label') == '1') selected @endif>电信</option>
                                    <option value="2" @if(Request::get('label') == '2') selected @endif>联通</option>
                                    <option value="3" @if(Request::get('label') == '3') selected @endif>移动</option>
                                    <option value="4" @if(Request::get('label') == '4') selected @endif>教育网</option>
                                    <option value="5" @if(Request::get('label') == '5') selected @endif>其他网络</option>
                                    <option value="6" @if(Request::get('label') == '6') selected @endif>免费体验</option>
                                </select>
                            </div>
                            <div class="col-md-2 col-sm-2">
