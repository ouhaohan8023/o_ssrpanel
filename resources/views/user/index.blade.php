...
@section('content')
    ...
    <div class="page-content" style="padding-top:0;">
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="well" style="background-color: #FFF;">
                    ...
                    <button class="btn btn-sm blue" data-toggle="modal" data-target="#show_all"> SSR全部 </button>
                </div>
        ...
        <div id="show_all" class="modal fade" tabindex="-1" data-focus-on="input:first" data-keyboard="false">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                        <h4 class="modal-title"> 展示所有节点的SSR地址 </h4>
                    </div>
                    <div class="modal-body">
