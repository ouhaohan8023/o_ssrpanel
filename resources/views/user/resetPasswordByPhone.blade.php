...
<div class="content">
    ...
    <form class="forget-form" action="{{url('resetPasswordByPhone')}}" method="post" style="display: block;">
        @if($is_reset_password)
            <div class="form-title">
                <span class="form-title">请输入您收到的验证码</span><br/>
            </div>
            <div class="form-group">
                <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="再此输入验证码" name="code" required autofocus />
                @if (isset($phone))
                    <input type="text" name="phone" value="{{$phone}}" style="display: none"/>
                @else
                    <input type="text" name="phone" value="{{Request::old('phone')}}" style="display: none"/>
                @endif
