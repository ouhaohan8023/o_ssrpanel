        ...
        <div class="page-sidebar navbar-collapse collapse">
            ...
            <ul class="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                ...
                <li class="nav-item {{in_array(Request::path(), ['user/download']) ? 'active open' : ''}}">
                    <a href="{{url('user/download')}}" class="nav-link nav-toggle">
                        <i class="icon-user-follow"></i>
...
<div class="page-footer">
    <div class="page-footer-inner"> 2017 - 2018 &copy; <a href="https://github.com/ssrpanel/ssrpanel" target="_blank">{{env('APP_NAME')}}</a> </div>
