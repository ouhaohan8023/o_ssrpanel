...
<div class="content">
    ...
    <form class="login-form" action="{{url('login')}}" method="post">
        ...
        <div class="form-actions">
            <button type="submit" class="btn red btn-block uppercase" style="font-size: 16px;font-weight: 300">{{trans('login.login')}}</button>
        </div>
        @if($is_register)
            <div class="form-actions">
                <a href="{{url('register')}}">
                    <button type="button" class="btn red btn-block uppercase" style="font-size: 16px;font-weight: 300;background-color: inherit;border-color: #FFFFFF">{{trans('login.register')}}</button>
                </a>
            </div>
        @endif
    </form>
