...
//    {
//      $url = '/home/wwwroot/'.env('APP_SITENAME').'/public/s/';
//      $name = '1.txt';
//      $filename=realpath($url.$name); //文件名
...
//      $url = '/home/wwwroot/'.env('APP_SITENAME').'/public/s/';
//        $name = makeRandStr(20).'.txt';
//      $myfile = fopen($url.$name, "w+") or die("Unable to open file!");
//      $txt = base64url_encode($scheme);
//      fwrite($myfile, $txt);
//      fclose($myfile);
//      $filename=realpath($url.$name); //文件名
//      Header( "Content-type:  application/octet-stream ");
