...
//        $area = self::getCity($ip);
  ...
  protected function TenMinutesEmail($username){
    if(strstr($username,'molms')
        ...
        ||strstr($username,'armyspy.com')
        ||strstr($username,'cuvox.de')
        ||strstr($username,'dayrep.com')
        ||strstr($username,'einrot.com')
        ||strstr($username,'fleckens.hu')
        ||strstr($username,'gustr.com')
        ||strstr($username,'jourrapide.com')
        ||strstr($username,'rhyta.com')
        ||strstr($username,'superrito.com')
        ||strstr($username,'teleworm.us')
        ||strstr($username,'itoup.com')
        ||strstr($username,'hubii-network.com')
//        ||strstr($username,'tempinbox.com')
//        ||strstr($username,'tempinbox.com')
